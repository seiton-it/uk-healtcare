...
abstract class CoreDialogFragment : DialogFragment() {
    ...
    override fun onAttach(context: Context?) {
        ...
        Log.d(this.javaClass.name, "(DF)::onAttach(context), empty: ${context == null}, contextClass: ${context?.javaClass?.name}")
    }

    override fun onAttach(activity: Activity?) {
        super.onAttach(activity)
        Log.d(this.javaClass.name, "(DF)::onAttach(activity), empty: ${context == null}, contextClass: ${activity?.javaClass?.name}")
    }
